...
//                   children: [
//                     Text(
//                       '${'passenger'.tr} x ${data.ticket.service_fee}',
//                       style: TextStyles.desc,
//                     ),
//                     horizontalSpace(Insets.sm),
//                     Expanded(
//                       child: Text(
//                         priceFormat(data.ticket.total_payement * data.ticket.guest),
...
//                       child: Text(
//                         priceFormat(
//                           (data.ticket.total_payement * data.ticket.guest) 
...
//                     Expanded(
//                       child: Text(
//                         priceFormat(data.ticket.total_payement),
//                         style: TextStyles.title.copyWith(
//                           fontSize: 12.w,
//                           color: AppColor.primaryColor,
//                         ),
