import 'package:flextrip/app/modules/hotel_booking/explore/home_explore_slider_view.dart';
import 'package:flextrip/app/modules/hotel_booking/explore/hotel_list_view_page.dart';
import 'package:flextrip/app/modules/hotel_booking/explore/popular_list_view.dart';
import 'package:flextrip/app/modules/hotel_booking/explore/title_view.dart';
import 'package:flextrip/app/modules/hotel_booking/hotel_detailes/hotel_detailes.dart';
...
import 'package:flextrip/app/modules/hotel_booking/widgets/bottom_top_move_animation_view.dart';
...
import 'package:flextrip/app/modules/hotel_booking/widgets/common_search_bar.dart';
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (index == 0) {
                      return TitleView(
                        titleTxt:"popular_destination".tr,
                        subTxt: '',
                        animation: animation,
                        animationController: widget.animationController,
                        click: () {},
        ...
        HotelListViewPage(
          callback: () {
           // NavigationServices(context).gotoHotelDetailes(f);
             ...
             Navigator.push(context,
                 MaterialPageRoute(builder: (context)=>  HotelDetailes(hotelData:f)
                                    ));
          },
          hotelData: f,
          animation: animation,
