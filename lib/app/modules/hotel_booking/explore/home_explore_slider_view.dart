...
import 'package:flextrip/app/modules/hotel_booking/splash/components/page_pop_view.dart';
...
class _HomeExploreSliderViewState extends State<HomeExploreSliderView> {
  ...
  void initState() {
    pageViewModelData.add(PageViewData(
      titleText: 'cape Town'.tr,
      subText: 'five_star'.tr,
      assetsImage: Localfiles.explore_2,
    ));
    pageViewModelData.add(PageViewData(
      titleText: 'find_best_deals'.tr,
      subText: 'five_star'.tr,
